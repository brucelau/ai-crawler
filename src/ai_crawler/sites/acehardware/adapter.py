"""Acehardware site adapter — search command."""
...
@register(site="acehardware", command="search")
class AcehardwareSearch(Command):
    site = "acehardware"
    command = "search"
    url_template = "https://www.acehardware.com/search?query={query}"
    ...
    def extract_detail(self, html: str, url: str) -> dict:
        """Extract product detail fields from a Acehardware product page."""
        soup = BeautifulSoup(html, "html.parser")
