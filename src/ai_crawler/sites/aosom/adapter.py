"""Aosom site adapter — search command."""
...
@register(site="aosom", command="search")
class AosomSearch(Command):
    site = "aosom"
    command = "search"
    url_template = "https://www.aosom.com/search?q={query}"
    ...
    def extract_detail(self, html: str, url: str) -> dict:
        """Extract product detail fields from a Aosom product page."""
        soup = BeautifulSoup(html, "html.parser")
