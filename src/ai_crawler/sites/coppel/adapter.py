"""Coppel site adapter — search command."""
...
@register(site="coppel", command="search")
class CoppelSearch(Command):
    site = "coppel"
    command = "search"
    url_template = "https://www.coppel.com/buscar?q={query}"
    ...
    def extract_detail(self, html: str, url: str) -> dict:
        """Extract product detail fields from a Coppel product page."""
        soup = BeautifulSoup(html, "html.parser")
