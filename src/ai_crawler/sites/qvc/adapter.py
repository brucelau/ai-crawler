"""Qvc site adapter — search command."""
...
@register(site="qvc", command="search")
class QvcSearch(Command):
    site = "qvc"
    command = "search"
    url_template = "https://www.qvc.com/catalog/search.html?keyword={query}"
    ...
    def extract_detail(self, html: str, url: str) -> dict:
        """Extract product detail fields from a Qvc product page."""
        soup = BeautifulSoup(html, "html.parser")
