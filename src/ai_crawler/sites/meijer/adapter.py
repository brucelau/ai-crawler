"""Meijer site adapter — search command."""
...
@register(site="meijer", command="search")
class MeijerSearch(Command):
    site = "meijer"
    command = "search"
    url_template = "https://www.meijer.com/shopping/search.html?text={query}"
    ...
    def extract_detail(self, html: str, url: str) -> dict:
        """Extract product detail fields from a Meijer product page."""
        soup = BeautifulSoup(html, "html.parser")
