"""Fivebelow site adapter — search command."""
...
@register(site="fivebelow", command="search")
class FivebelowSearch(Command):
    site = "fivebelow"
    command = "search"
    url_template = "https://www.fivebelow.com/search?q={query}"
    ...
    def extract_detail(self, html: str, url: str) -> dict:
        """Extract product detail fields from a Fivebelow product page."""
        soup = BeautifulSoup(html, "html.parser")
