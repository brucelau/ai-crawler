...
from ai_crawler.core.engine.handler import AntiBotHandler, BlockDetectionContext, BlockType
...
class FetchEngineer:
    ...
    def _should_short_circuit_retry(
        self, task: CrawlTask, strategy: CrawlStrategy, html: str, block_type: str
    ) -> bool:
    ...
    @staticmethod
    def _estimate_cost(strategy: CrawlStrategy, latency_ms: float) -> float:
