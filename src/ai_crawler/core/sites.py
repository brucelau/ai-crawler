"""Site configuration — URL templates, tier defaults, strategy chains, and domain mappings.

Moved from config/sites.py.
"""

from ai_crawler.core.types import CrawlPolicy, PagePattern, ProxyType, RenderType
...
def _load_from_yaml() -> dict:
    """Load site configuration from YAML file (future migration path)."""
    try:
        import yaml
