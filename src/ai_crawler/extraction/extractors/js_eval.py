...
from ai_crawler.extraction.base import ExtractionResult, ExtractionStrategy
from ai_crawler.sites import get_js_code
from ai_crawler.core.types import Product
from ai_crawler.core.sites import infer_site_from_url

log = structlog.get_logger()


class JSEvaluateExtractor(ExtractionStrategy):
    name = "js_eval"
