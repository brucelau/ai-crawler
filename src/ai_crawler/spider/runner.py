...
from ai_crawler.spider.engine.captcha import CaptchaService
from ai_crawler.spider.engine.anti_bot.fetch_engineer import FetchEngineer
from ai_crawler.spider.engine.anti_bot.handler import AntiBotHandler, BlockType
...
from ai_crawler.spider.engine.core.queue import Queue, SiteCircuitBreaker, MemoryStore
...
from ai_crawler.spider.runtime.crawl import CrawlTask
...
class CrawlRunner:
    ...
    def __init__(
        ...
        from ai_crawler.spider.extraction.engine import ExtractionEngine
        from ai_crawler.spider.extraction.engine.policy_engine import ExtractionPolicyEngine
        from ai_crawler.spider.extraction.engine.registry import create_strategy, list_strategies
