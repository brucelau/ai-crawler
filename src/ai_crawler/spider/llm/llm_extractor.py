...
from ai_crawler.spider.extraction import build_axtree_selector_sample
from ai_crawler.spider.extraction.templates.template_store import template_store
from ai_crawler.spider.extraction.analysis.validators import validate_selector
...
class LLMExtractor:
    ...
    def _get_dspy_extractor(self):
        ...
        if self._dspy_extractor is None:
            from ai_crawler.spider.llm.dspy_model import SelectorExtractor
