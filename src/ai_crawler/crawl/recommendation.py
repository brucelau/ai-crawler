...
from ai_crawler.core.types import CrawlPolicy, CrawlTask, ProxyType, RenderType
...
class DSPyStrategyRecommender:
    ...
    def recommend(self, task: CrawlTask, block_type: str, snippet: str) -> CrawlPolicy | None:
    ...
    @staticmethod
    def _result_to_strategy(result) -> CrawlPolicy:
        proxy_map = {
