...
from ai_crawler.fetch import Fetcher, FetchEngineer
from ai_crawler.antidetect.captcha import CaptchaService
from ai_crawler.antidetect.handler import AntiBotHandler, BlockType
...
from ai_crawler.crawl.queue import Queue, SiteCircuitBreaker, MemoryStore
...
class CrawlRunner:
    ...
    def __init__(
        ...
        self._planner = Planner(memory_store=memory_store, strategy_mode=strategy_mode)
